...
export const fictionPosts = [
    ...
    {   title: "Some Chicks",
        author: "Sophia Mills",
        excerpt: "[At a party, ELLE stands against the door while MAGGY tries to exit, ELLE blocks the door pleading]. ELLE: I'm going to tell him soon. You don't need to leave. I'm sorry- [ELLE’s beer bottle falls from her hands] Shit, I'm so sorry. Just don't leave, just don't"},

    {   title: "Under the Open Window",
        author: "Hailey Nelson",
        excerpt: "The carpet feels grainy under me as I lay in the little patch of sunlight seeping through my open window. A window I pray would shut silently so as to not bring any awareness towards me. A slight breeze blows through, the quiet of the neighborhood falling densely on the day. Eerily, not even the usual sound of birds chirping in the afternoon sound through."},

    {   title: "Grown Women do as They'd Like",
        author: "Nicholas Nova",
        excerpt: "Vandeberg’s mobile home park. Seventy-five homes, twenty-two acres. Half were single wide, and the other half doubles. It was where I hoped to live with Cheryl when we got married—before we’d fought. The police were on the front stoop, so I kicked a few beer cans out of the way and opened the door to see what they wanted."}
];