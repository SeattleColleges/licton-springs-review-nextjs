...
while current_issue_num <= triggered_issue_num:
    ...
    response = requests.get(
        f'https://api.github.com/repos/SeattleColleges/licton-springs-review-nextjs/issues/{current_issue_num}',
        headers={
    ...
    smartsheet_response = requests.post(
        ...
        json={
            ...
            'cells': [
                ...
                {
                    'columnId': 6100962363264900,  # "Repo"
                    'value': repo_url[45:]
                },
                {
                    'columnId': 8352762176950148,  # "Assigned To"
                    'value': assignee
                },
                {
                    'columnId': 1034412782473092,  # "Index"
                    'value': index
                }
            ]
        }
